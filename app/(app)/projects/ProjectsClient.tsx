...
export function ProjectsClient({ initialData }: { initialData: ProjectsData }) {
                    ...
                    <tr key={project.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="p-4">
                        {project.thumbnail ? (
                          ...
                          <div className="w-12 h-12 bg-gradient-to-br from-sky-400 via-indigo-500 to-purple-600 rounded-lg" />
                        )}
                      </td>
                ...
                <div key={project.id} className="p-3 sm:p-4 hover:bg-gray-50 transition-colors">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    {project.thumbnail ? (
                      ...
                      <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-sky-400 via-indigo-500 to-purple-600 rounded-lg flex-shrink-0" />
                    )}
