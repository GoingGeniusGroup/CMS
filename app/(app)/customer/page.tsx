...
export default async function CustomerPage({
  ...
  const stats = [
    { icon: Users, label: "Total Clients", value: String(statsResult.total ?? 0) },
    { icon: UserCheck, label: "Active Clients", value: String(statsResult.active ?? 0) },
    { icon: UserPlus, label: "New Clients", value: String(statsResult.newThisMonth ?? 0) },
