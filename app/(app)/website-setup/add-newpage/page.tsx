...
export default function AddNewPage() {
  ...
  const hasChanges = !!(title || slug || content || thumbnail || metaTitle || metaDesc || keywords || metaImage || addToNav);
  ...
  return (
    <div className="flex flex-col gap-5">
      {/* Sticky Top Bar */}
      <div className="sticky top-0 z-10 -mx-6 -mt-5 border-b border-zinc-200 bg-white px-6 py-4 sm:-mx-8 sm:-mt-6 sm:px-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-zinc-900">Add New Page</h1>
            <p className="text-sm text-zinc-500">Create a new page for your website.</p>
          </div>
          {hasChanges && (
