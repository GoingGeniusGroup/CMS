          ...
          <div className="min-w-[220px] flex-1">
            ...
            <ul className="mt-4 space-y-3">
              <li className="flex items-center gap-2 text-sm text-zinc-400">
                <Mail className="h-4 w-4 shrink-0" /> goinggenius2021@gmail.com
              </li>
              <li className="flex items-center gap-2 text-sm text-zinc-400">
                <Phone className="h-4 w-4 shrink-0" /> 976-8527869
              </li>
              <li className="flex items-start gap-2 text-sm text-zinc-400">
                <MapPin className="h-4 w-4 shrink-0 mt-0.5" /> Milan Chowk Marga, Kathmandu 44600
              </li>
            </ul>
          </div>
        </div>
